...
- (void)willRotateToInterfaceOrientation:(UIInterfaceOrientation)toInterfaceOrientation duration:(NSTimeInterval)duration {
	...
	if([self.visibleViewController isKindOfClass:[FGalleryViewController class]]) {
		...
		BOOL shouldHideStatusBar = UIInterfaceOrientationIsLandscape(toInterfaceOrientation);

		[[UIApplication sharedApplication] setStatusBarHidden:shouldHideStatusBar withAnimation:UIStatusBarAnimationSlide];
