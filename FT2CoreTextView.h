...
@protocol FT2CoreTextViewDelegate;

@interface FT2CoreTextView : UIView {
...
@property (nonatomic, assign) id <FT2CoreTextViewDelegate> delegate;
...
@protocol FT2CoreTextViewDelegate <NSObject>
@optional
- (void)touchedData:(NSDictionary *)data inCoreTextView:(FT2CoreTextView *)textView __deprecated;
- (void)coreTextView:(FT2CoreTextView *)coreTextView receivedTouchOnData:(NSDictionary *)data;
@end
